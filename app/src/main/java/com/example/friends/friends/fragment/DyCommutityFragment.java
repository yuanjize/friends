...
public class DyCommutityFragment extends Fragment {

    private RecyclerView recyclerView;
    private List<DynamticInfo> info;

    public DyCommutityFragment() {
...
//=============================测试数据
        ...
        View view = inflater.inflate(R.layout.fragment_dy_commutity, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.commutity_content);
