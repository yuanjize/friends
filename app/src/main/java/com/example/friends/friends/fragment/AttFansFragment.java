 ...
 */
public class AttFansFragment extends android.support.v4.app.Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_att_fans, container, false);
        findViewByIds();
...
*/
    ...
    class MyAdapter extends BaseAdapter implements View.OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(AttFansFragment.this.getActivity(), R.layout.fans_item_layout, null);
            ...
            viewHolder.fansName.setText("漂泊大西洋");
            viewHolder.fansSign.setText("雨好大~~~~");
            //---------------------------------------------------------------
            return convertView;
        }
